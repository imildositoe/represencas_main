...
<script>
    ...
    import Tbl from '../../assets/components/Table';
    import TblHead from '../../assets/components/TableHead';
    import TblBody from '../../assets/components/TableBody';
    import Pagination from '../../assets/components/Pagination';
    import PageItem from '../../assets/components/PageItem';
